...
desc 'Generate documentation for the calculator_colissimo extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'CalculatorColissimoExtension'
...
desc 'Test the calculator_colissimo extension.'
...
namespace :test do
  desc 'Functional test the calculator_colissimo extension.'
  ...
  desc 'Unit test the calculator_colissimo extension.'
